...
import final1 from '../assets/image33.png'
      ...
      <section className="case-study">
        ...
        <section className="case-study-section">
          ...
          <div className="case-study-section-body">
            <p><strong>Blå Sol</strong> is a non-profit music festival focused on bringing people together through music and community. The festival already had an app, and our project focused on improving the existing experience by introducing new features to help young festival-goers stay connected with their friends in crowded festival environments.</p>
            <p>Working as part of a team, I contributed to <strong>user research, persona development, ideation, UX design, usability testing, and front-end coding</strong>. I also worked on the <strong>app&apos;s visual direction and refining the interface based on user feedback</strong>.</p>
            <p>The final solution introduced features such as a social map for finding friends, quick location sharing, and easier group coordination. Through <strong>several iterations</strong>, we explored additional features such as a live map and latest notifications, using testing feedback to improve navigation and make key interactions easier to understand.</p>
            <p>This project demonstrates my ability to <strong>translate user needs into practical features, use testing to improve designs, and bring UX/UI concepts into a working interface through front-end development</strong>.</p>
          </div>
        </section>
