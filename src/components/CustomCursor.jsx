    ...
    <div className="custom-cursor-pos" ref={posRef} style={{ opacity: 0 }}>
      <svg className="custom-cursor-icon" ref={iconRef} width="34" height="43.8" viewBox="0 0 225 290">
        ...
        <path
          fill="#111"
          d="M76,64
             C95,85 155,120 185,155
             C186,178 185,205 183,232
             C181,255 168,272 150,272
             C133,272 122,252 114,238
             C108,246 100,246 94,244
             C74,240 62,225 60,208
             C58,178 60,115 65,82
             C69,73 72,67 76,64
             Z"
        />
      </svg>
